...
export const PAN_INDIA_CATEGORIES = [
  { id: 'all', label: 'All Places', icon: 'Sparkles', color: '#C89B3C' },
  { id: 'temples', label: 'Temples & Religious', icon: 'Church', color: '#D97706' },
  { id: 'monuments', label: 'Monuments & Forts', icon: 'Castle', color: '#8F2633' },
  { id: 'food', label: 'Local Food & Street Eats', icon: 'Utensils', color: '#B65C3A' },
  { id: 'museums', label: 'Museums & Culture', icon: 'Landmark', color: '#6B4423' },
  { id: 'scenic', label: 'Scenic & Natural Spots', icon: 'Mountain', color: '#234A3A' }
];
  ...
  try {
    ...
    const response = await fetch('https://overpass-api.de/api/interpreter', {
      ...
      headers: {
        ...
        'User-Agent': 'ExplorerIQ-Heritage/2.5'
      }
    });
    ...
    const formattedPlaces = elements
      ...
      .map((el, idx) => {
        ...
        let badgeColor = 'bg-[#8F2633]/15 text-[#8F2633] border-[#8F2633]/30';
...
function generateCuratedPlaces(state, district, categoryId) {
  ...
  const templates = [
    {
      ...
      cat: 'monument',
      badge: 'bg-[#57151E]/15 text-[#57151E] border-[#57151E]/30',
      fee: '₹50 (ASI Entry)',
    ...
    },
    {
      ...
      cat: 'food',
      badge: 'bg-[#B65C3A]/15 text-[#B65C3A] border-[#B65C3A]/30',
    ...
    },
    {
      ...
      cat: 'museum',
      badge: 'bg-[#6B4423]/15 text-[#6B4423] border-[#6B4423]/30',
    ...
    },
    {
      ...
      cat: 'scenic',
      badge: 'bg-[#234A3A]/15 text-[#234A3A] border-[#234A3A]/30',
      fee: 'Free Entry',
  ...
  templates.forEach((tmpl, idx) => {
    if (categoryId !== 'all' && tmpl.cat !== categoryId) return;
